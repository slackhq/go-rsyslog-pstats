...
Before opening a new issue, please consider:
  ...
  - Trying out the examples [provided in this repository](https://github.com/slackhq/go-rsyslog-pstats#getting-set-up).
  ...
  - Finally, [**open an issue**](https://github.com/slackhq/go-rsyslog-pstats/issues/new) to report a bug, ask for help or suggest a feature. The more information you give, the better people can help you.
...
- [Fork the repository](https://github.com/slackhq/go-rsyslog-pstats) and make sure to work on a branch up to date with origin master.
- Do your thing!
